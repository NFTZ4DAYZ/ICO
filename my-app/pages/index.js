  ...
  return (
    <div>
      ...
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to the last ICO you'll ever ape!</h1>
          <div className={styles.description}>
          ...
          {walletConnected ? (
            <div>
              <div className={styles.description}>
                ...
                You stacked up {utils.formatEther(balanceOfCryptoDevTokens)} mysterious tokens.  No 
                one knows what they might be for???
              </div>
              <div className={styles.description}>
                {/* Format Ether helps us in converting a BigNumber to string */}
                Overall {utils.formatEther(tokensMinted)}/10000 have been minted!!!
                Time to delete my code & start over!
              </div>
              {renderButton()}
